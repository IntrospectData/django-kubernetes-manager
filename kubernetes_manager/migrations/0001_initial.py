    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cluster', models.ForeignKey(help_text='ForeignKey to TargetCluster object.', null=True, on_delete=django.db.models.deletion.SET_NULL, to='kubernetes_manager.TargetCluster')),
                ('primary_container', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='primary_container', to='kubernetes_manager.KubernetesContainer')),
                ('secondary_container', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='secondary_container', to='kubernetes_manager.KubernetesContainer')),
                ('volume', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='kubernetes_manager.KubernetesVolume')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='kubernetescontainer',
            name='volume_mount',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='kubernetes_manager.KubernetesVolumeMount'),
        ),
        migrations.CreateModel(
