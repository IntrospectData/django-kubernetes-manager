# Generated by Django 3.0.5 on 2020-04-07 22:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('volumes', models.ManyToManyField(blank=True, help_text='All volumes to be created for a pod.', null=True, to='kubernetes_manager.KubernetesVolume')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='kubernetescontainer',
            name='volume_mounts',
            field=models.ManyToManyField(blank=True, help_text='Mounts for any number of volumes', null=True, to='kubernetes_manager.KubernetesVolumeMount'),
        ),
        migrations.CreateModel(
